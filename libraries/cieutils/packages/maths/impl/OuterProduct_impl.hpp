...
constexpr bool OuterProduct<Dimension>::next(TItBegin itOptionsBegin,
                                             TItEnd itOptionsEnd,
                                             Ptr<TValue> itStateBegin) {
...
template <unsigned Dimension>
template <std::incrementable TValue>
constexpr bool OuterProduct<Dimension>::next(Ptr<const Ptr<const TValue>> itOptionBeginsArray,
