...
ScaleTranslateTransform<TValue,Dimension>::ScaleTranslateTransform(RightRef<std::array<TValue,Dimension>> rScales,
...
template <concepts::Numeric TValue, unsigned Dimension>
TranslateScaleTransform<TValue,Dimension>::TranslateScaleTransform(RightRef<std::array<TValue,Dimension>> rScales,
                                                                   RightRef<std::array<TValue,Dimension>> rOffset) noexcept
    : _scales(std::move(rScales)),
      _offset(std::move(rOffset))
{
